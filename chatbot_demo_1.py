...
# App title
st.set_page_config(page_title='Career Counseling Chatbot')
...
def generate_llama2_response(prompt_input):
    string_dialogue = "You are a helpful career counseling assisstant, you provide thoughtful and professional career advice. Please do not hallucinate. check grammar before prompting the user."
